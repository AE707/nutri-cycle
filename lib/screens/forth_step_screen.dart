...
import 'fifth_step_screen.dart';

class ForthStepScreen extends StatefulWidget {
  static String screenRoute = 'forth_step_screen';

  const ForthStepScreen({super.key});

  @override
  State<ForthStepScreen> createState() => _ForthStepScreenState();
}

class _ForthStepScreenState extends State<ForthStepScreen> {
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Connaissez-vous le lien entre votre cycle et'
                  '  votre vie sexuelle ?',
                  style: GoogleFonts.roboto(
                    fontSize: 18,
                    fontWeight: FontWeight.w700,
                ...
                MyButton(
                  ...
                  title: 'Oui',
                  onPressed: () {
                    Navigator.pushNamed(context, FifthStepScreen.screenRoute);
                  },
                ),
                SizedBox(
                  height: 5.h,

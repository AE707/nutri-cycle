...
import 'forth_step_screen.dart';

class ThirdStepScreen extends StatefulWidget {
  static String screenRoute = 'third_step_screen';
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Vos règles sont-elles déjà arrivées par      surprise ?',
                  style: GoogleFonts.roboto(
                    fontSize: 18,
                    fontWeight: FontWeight.w700,
                    color: const Color.fromRGBO(255, 255, 255, 1),
                ...
                MyButton(
                  ...
                  width: 50,
                  title: 'Oui, Parfois / Oui, à chaque fois',
                  onPressed: () {
                    Navigator.pushNamed(context, ForthStepScreen.screenRoute);
                  },
                ),
                SizedBox(
                  height: 5.h,
                ...
                MyButton(
                    ...
                    colorT: const Color.fromRGBO(0, 0, 0, 1),
                    width: 50,
                    title: 'Jamais / Je ne souhaite pas répondre',
                    onPressed: () {
                      Navigator.pushNamed(context, ForthStepScreen.screenRoute);
                    }),
                SizedBox(

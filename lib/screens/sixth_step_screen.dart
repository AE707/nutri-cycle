...
class SixthStepScreen extends StatefulWidget {
  static String screenRoute = 'sixth_step_screen';

  const SixthStepScreen({super.key});

  @override
  State<SixthStepScreen> createState() => _SixthStepScreenState();
}

class _SixthStepScreenState extends State<SixthStepScreen> {
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Vos symptômes prémenstruels sont-ils supportables ?',
                  style: GoogleFonts.roboto(
                    fontSize: 18,
                    fontWeight: FontWeight.w700,
                    color: const Color.fromRGBO(255, 255, 255, 1),
                ...
                MyButton(
                  ...
                  title: 'Oui',
                  onPressed: () {
                    Navigator.pushNamed(context, SplashScreen1.screenRoute);
                  },
                ),
                SizedBox(
                  height: 5.h,

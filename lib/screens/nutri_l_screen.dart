...
class NutriLScreen extends StatefulWidget {
  static const String screenRoute = 'nuti_l_screen';
  const NutriLScreen({super.key});

  @override
  State<NutriLScreen> createState() => _NutriLScreenState();
}

class _NutriLScreenState extends State<NutriLScreen> {

...
class CardDetailScreen3 extends StatefulWidget {
  static const String screenRoute = 'card_detail_screen3_screen';
  const CardDetailScreen3({super.key});

  @override
  State<CardDetailScreen3> createState() => _CardDetailScreen3State();
}

class _CardDetailScreen3State extends State<CardDetailScreen3> {

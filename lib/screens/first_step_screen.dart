...
class FirstStepScreen extends StatefulWidget {
  static String screenRoute = 'first_step_screen';
...
class _FirstStepScreenState extends State<FirstStepScreen> {
  String fullName = "Loading..."; // Default text while loading data
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Suivez-vous votre cycle menstruel 🩸 ?',
                  style: GoogleFonts.roboto(
                    fontSize: 18,
                    fontWeight: FontWeight.w700,
                    color: const Color.fromRGBO(255, 255, 255, 1),
                ...
                MyButton(
                  ...
                  title: 'Oui',
                  onPressed: () {
                    Navigator.pushNamed(context, SecondStepScreen.screenRoute);
                  },
                ),
                SizedBox(
                  height: 5.h,
                ...
                MyButton(
                    ...
                    colorT: const Color.fromRGBO(0, 0, 0, 1),
                    width: 50,
                    title: 'Non, je ne pensais pas que c’était nécessaire',
                    onPressed: () {
                      Navigator.pushNamed(
                          context, SecondStepScreen.screenRoute);
                    }),
                SizedBox(
                  height: 80.h,
                ),
